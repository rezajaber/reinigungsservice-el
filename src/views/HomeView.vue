...
import Einsatzorte from '../components/Einsatzorte.vue'
...
<template>
  <div>
    ...
    <ContactUs id="contact-us" class="bg-primary py-20 lg:py-24" />
    <Footer class="bg-popover-foreground py-8 lg:py-12" />
  </div>
</template>
